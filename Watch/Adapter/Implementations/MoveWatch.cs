namespace Watch.Adapter
{
    public class MoveWatch : IMove
    {
        ...
        { 
            ...
            graphics.DrawLine(new Pen(Color.White, 30f), new Point(175, 175), new Point(oldHourCoord[0], oldHourCoord[1]));
            graphics.DrawLine(new Pen(Color.White, 30f), new Point(175, 175), new Point(oldMinCoord[0], oldMinCoord[1]));
            graphics.DrawLine(new Pen(Color.White, 30f), new Point(175, 175), new Point(oldSecCoord[0], oldSecCoord[1]));
            ...
            graphics.DrawLine(new Pen(Color.Black, 5f), new Point(175, 175), new Point(newHourCoord[0], newHourCoord[1]));
            graphics.DrawLine(new Pen(Color.DarkGray, 4f), new Point(175, 175), new Point(newMinCoord[0], newMinCoord[1]));
            graphics.DrawLine(new Pen(Color.DarkOrange, 3f), new Point(175, 175), new Point(newSecCoord[0], newSecCoord[1]));
        }
    }
}